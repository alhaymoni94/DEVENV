...
| Tool | Purpose | Alias |
|------|---------|-------|
| **ai** | AI assistant (one-shot + pipe + interactive) | `ai` |
...
- [ ] Ask the AI a question: `ai "explain recursion"`
...
# Cargo tools need ~/.cargo/bin in PATH
...
```bash
# Test AI one-shot (requires API key)
ai "what is 2+2?"
...
**Expected**: ai returns an answer, opencode shows version.
